...
// Icono 3D = vista TOP estática (sin animación); mientras no exista, el SVG + spinner.
const { src: art3d, ready: art3dReady, pending: art3dPending } = use3dRender(() => genomeOf(props.instance), { views: ['top'] });
