...
const STR = {
  es: {
    ...
    elegiSlot: 'Toca una criatura y luego una casilla para colocarla. La columna central es la más protegida.',
    ...
    rondas: 'rondas', tuEquipo: 'Tu equipo', rival: 'Rival',
  ...
  en: {
    ...
    elegiSlot: 'Tap a critter then a cell to place it. The center column is the most protected.',
    ...
    rondas: 'rounds', tuEquipo: 'Your team', rival: 'Enemy',
