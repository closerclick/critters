...
- **Catálogo (`closerclick/`)**: Critters ya estaba registrado (juegos/solo); **refresqué la
  descripción** (fusión evolucionar/reforzar/devolucionar, 9 rarezas, rol y objetivo por
  criatura, campaña por estrellas). Deploy OK → **presente en https://closer.click** (confirmado
  en el bundle live).
- **Critters** desplegado hasta **SW v47** en https://critters.closer.click/.

## 2. Convenciones que faltaban (como las otras apps)
- **Botón de soporte**: agregué `<closer-click-support>` (moneda Ko-fi del ecosistema) al header
  (`npm i @closerclick/closer-click-support@0.3.8` + import en main.js).
...
## 5. Buffer
- Encolados (sin emojis, automatic): **Twitter @closerclick** (es, 261 chars) y **LinkedIn
  Closer Click** (en). Programados para 2026-06-07.
