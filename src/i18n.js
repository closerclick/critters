...
const STR = {
  es: {
    ...
    fusionPick: 'Elige la primera araña',
    fusionPick2: 'Elige la segunda (✓ sube rareza · las demás salen débiles)',
    fusionSube: 'sube rareza', fusionDebil: 'débil',
  ...
  en: {
    ...
    fusionPick2: 'Pick the second (✓ ranks up · others come out weak)',
    fusionSube: 'ranks up', fusionDebil: 'weak',
