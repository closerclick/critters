...
const STR = {
  es: {
    ...
    repetir: 'Repetir', siguiente: 'Siguiente', verBatalla: 'Ver batalla', verCampo: 'Ver campo', resumen: 'Resumen',
    ...
    evolucionar: 'Evolucionar', devolucionar: 'Devolucionar', evolucionaNota: 'Evoluciona: unión (+1 pieza)', devolucionaNota: 'Devoluciona: intersección (pierde lo diferente)',
    ...
    tabStats: 'Stats', tabElemento: 'Elemento', tabHabilidades: 'Habilidades', tabCombate: 'Combate',
    ...
    banquillo: 'Banquillo', banquilloVacio: 'Todas las arañas están en alguna alineación.', usar: 'Usar', enUso: 'En uso',
    teamHint: 'Arrastra entre alineaciones y banquillo. La columna derecha (▶) es el frente, hacia el rival. Toca una araña para ver/configurar.',
    rango: 'Rango',
  ...
  en: {
    ...
    repetir: 'Replay', siguiente: 'Next', verBatalla: 'Watch battle', verCampo: 'View field', resumen: 'Summary',
    ...
    evolucionar: 'Evolve', devolucionar: 'Devolve', evolucionaNota: 'Evolves: union (+1 piece)', devolucionaNota: 'Devolves: intersection (loses differing parts)',
    ...
    tabStats: 'Stats', tabElemento: 'Element', tabHabilidades: 'Abilities', tabCombate: 'Combat',
