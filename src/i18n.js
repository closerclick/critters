...
const STR = {
  es: {
    ...
    repetir: 'Repetir', siguiente: 'Siguiente', verBatalla: 'Ver batalla', verCampo: 'Ver campo', resumen: 'Resumen', pelearDeNuevo: 'Pelear de nuevo',
  ...
  en: {
    ...
    repetir: 'Replay', siguiente: 'Next', verBatalla: 'Watch battle', verCampo: 'View field', resumen: 'Summary', pelearDeNuevo: 'Fight again',
