...
const STR = {
  es: {
    ...
    tabStats: 'Stats', tabElemento: 'Elemento', tabHabilidades: 'Habilidades', tabCombate: 'Combate', ultimoEnf: 'Último enfrentamiento', rol: 'Rol', porRol: 'por rol',
  ...
  en: {
    ...
    tabStats: 'Stats', tabElemento: 'Element', tabHabilidades: 'Abilities', tabCombate: 'Combat', ultimoEnf: 'Last battle', rol: 'Role', porRol: 'per role',
